						...
						<div class="col-sm-6 col-lg-3">
							<div class="card p-3">
								<div class="d-flex align-items-center">
									...
									<div>
										<h5 class="mb-1"><b><a href="#"><small>Verified Appointments</small></a></b></h5>
										<small class="text-muted">{{appointmentStats.verified}}</small>
									</div>
								</div>
							</div>
						</div>
						<div class="col-sm-6 col-lg-3">
							<div class="card p-3">
								<div class="d-flex align-items-center">
									...
									<div>
										<h5 class="mb-1"><b><a href="#"><small>Pending Appointments</small></a></b></h5>
										<small class="text-muted">{{appointmentStats.pending}}</small>
									</div>
								</div>
							</div>
						</div>
						<div class="col-sm-6 col-lg-3">
							<div class="card p-3">
								<div class="d-flex align-items-center">
									...
									<div>
										<h5 class="mb-1"><b><a href="#"><small>Completed Appointments</small></a></b></h5>
										<small class="text-muted">{{appointmentStats.completed}}</small>
									</div>
								</div>
							</div>
						</div>
						<div class="col-sm-6 col-lg-3">
							<div class="card p-3">
								<div class="d-flex align-items-center">
									...
									<div>
										<h5 class="mb-1"><b><a href="#"><small>Cancelled Appointments</small></a></b></h5>
										<small class="text-muted">{{appointmentStats.cancelled }}</small>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6 col-lg-3">
							<div class="card p-3">
								<div class="d-flex align-items-center">
									...
									<div>
										<h5 class="mb-1"><b><a href="#"><small>Rejected Appointments</small></a></b></h5>
										<small class="text-muted">{{appointmentStats.rejected}}</small>
									</div>
								</div>
							</div>
						</div>
