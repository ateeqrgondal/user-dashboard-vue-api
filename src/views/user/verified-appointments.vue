				...
				<div class="content">
					<div class="page-inner">
						<div class="page-header">
							<h4 class="page-title">Verified Appointments</h4>
							<ul class="breadcrumbs">
								...
								<li class="nav-item">
									<a href="#">Verified Appointments</a>
								</li>
							</ul>
								...
								<div class="card">
									<div class="card-header">
										<div class="card-head-row">
											<div class="card-title">Verified Appointments List <span class="badge badge-secondary">{{appointmentStats.verified}}</span></div>
									...
									<div class="card-body">
													...
													<td>
														<div class="btn-group btn-group-page-header ml-auto">
															...
															<div class="dropdown-menu">
																...
																<a class="dropdown-item" href="#" data-toggle="modal" data-target="#appointment_details">Cancel</a>
															</div>
														</div>
													</td>
												</tr>
										...
										<div v-show="filteredVerifiedAppointments.length == 0" class="alert alert-secondary" role="alert">No pending appointments found.</div>
...
export default {
  ...
  computed: {
	isVerifiedAppointments (){
		return this.$store.getters['appointment/getVerified'].length !==0
	},
	verifiedAppointments (){
		return this.$store.getters['appointment/getVerified']
	},
	filteredVerifiedAppointments() {
		return this.verifiedAppointments.filter(appointment => {
	...
	methods: {
		...
		searchAppointments() {
			this.$store.dispatch('appointment/searchVerifiedAppointments', this.dateRange)
		},
		updateStatus(id) {
			...
			if (bottomOfWindow) {
				this.loadingData = true
					if(this.page < this.lastPage) {
							this.page++
							this.$store.dispatch ( 'appointment/getMoreVerified', this.page ).then ( response => {
	...
	mounted () {
	if(!this.isVerifiedAppointments){
		this.$store.dispatch('appointment/getVerified', this.page).then(response => {
